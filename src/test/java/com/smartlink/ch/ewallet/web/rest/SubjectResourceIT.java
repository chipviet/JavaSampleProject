...
import com.smartlink.ch.ewallet.repository.SubjectRepository;
...
public class SubjectResourceIT {
    ...
    public static Subject createEntity(EntityManager em) {
        Subject subject = new Subject()
            .nameSubject(DEFAULT_NAME_SUBJECT);
        return subject;
    }
    /**
    ...
    public static Subject createUpdatedEntity(EntityManager em) {
        Subject subject = new Subject()
            .nameSubject(UPDATED_NAME_SUBJECT);
        return subject;
    }
    ...
    public void createSubject() throws Exception {
        ...
        assertThat(testSubject.getNameSubject()).isEqualTo(DEFAULT_NAME_SUBJECT);
    }
    ...
    public void updateSubject() throws Exception {
        ...
        Subject testSubject = subjectList.get(subjectList.size() - 1);
        assertThat(testSubject.getNameSubject()).isEqualTo(UPDATED_NAME_SUBJECT);
    }
