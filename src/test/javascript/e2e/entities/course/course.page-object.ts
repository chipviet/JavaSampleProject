...
export class CourseDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('tutorApp.course.delete.question'));
...
export default class CourseComponentsPage {
  ...
  async deleteCourse() {
    ...
    expect(await courseDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/tutorApp.course.delete.question/);
