...
export const SubjectUpdate = (props: ISubjectUpdateProps) => {
  ...
  const { subjectEntity, tutorDetails, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tutorApp.subject.home.createOrEditLabel">
            <Translate contentKey="tutorApp.subject.home.createOrEditLabel">Create or edit a Subject</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : subjectEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameSubjectLabel" for="subject-nameSubject">
                  <Translate contentKey="tutorApp.subject.nameSubject">Name Subject</Translate>
                </Label>
                <AvField id="subject-nameSubject" type="text" name="nameSubject" />
              </AvGroup>
              <AvGroup>
                <Label for="subject-tutorDetails">
                  <Translate contentKey="tutorApp.subject.tutorDetails">Tutor Details</Translate>
                </Label>
                <AvInput id="subject-tutorDetails" type="select" className="form-control" name="tutorDetails.id">
                  <option value="" key="0" />
                  {tutorDetails
