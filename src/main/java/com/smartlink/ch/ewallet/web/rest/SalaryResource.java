...
/**
 * REST controller for managing {@link com.smartlink.ch.ewallet.domain.Salary}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SalaryResource {
    ...
    public ResponseEntity<Salary> createSalary(@RequestBody Salary salary) throws URISyntaxException {
     ...
     */
    @PutMapping("/salaries")
    public ResponseEntity<Salary> updateSalary(@RequestBody Salary salary) throws URISyntaxException {
